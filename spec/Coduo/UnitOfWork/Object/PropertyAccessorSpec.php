...
class PropertyAccessorSpec extends ObjectBehavior
{
    ...
    function it_throw_exception_when_accessing_not_existing_property()
    {
        ...
        $this->shouldThrow(
            new NotExistingPropertyException("Property \"notExistingPropertyName\" does not exists in \"Coduo\\UnitOfWork\\Tests\\Double\\ProtectedEntity\" class.")
